...
tags:
- Lévy Processes (Lévy 프로세스)
- Neural Bayes Estimation (신경망 베이즈 추정)
- Likelihood-Free Inference (우도-자유 추론)
- Amortized Inference (상각된 추론)
- DeepSets Architecture (DeepSets 아키텍처)
